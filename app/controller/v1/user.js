...
class SigninController extends egg_1.Controller {
    ...
    async create() {
        ...
        if (!!findResult) {
            this.ctx.body = reply_1.default.err('已有此用户');
            return;
        }
        const newUserInfo = {
    ...
    async searchByNameOrId() {
        ...
        if (!userInfo.length) {
            this.ctx.body = reply_1.default.err('没有符合条件的用户');
            return;
        }
    ...
    async queryUserById() {
        ...
        if (!userInfo) {
            this.ctx.body = reply_1.default.err('没有此用户相关信息');
        }
    ...
    async updateUserById() {
        ...
        let result = {};
        if (!userInfo) {
            result = reply_1.default.err("更新失败");
            this.ctx.body = result;
        }
        this.ctx.body = reply_1.default.success(userInfo);
    }
    async freeze() {
        const Joi = this.app.Joi;
        const model = this.ctx.model;
