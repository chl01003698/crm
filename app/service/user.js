...
class UserService extends egg_1.Service {
    async createUser(userInfo) {
        ...
        if (userInfo.teams) {
            ...
            if (!teamInfo) {
                return reply_1.default.err("没有此组织");
            }
        ...
        if (userInfo.roleName) {
            ...
            if (!roleInfo) {
                return reply_1.default.err("没有此等级");
            }
        ...
        if (userInfo.parentId) {
            ...
            if (!user) {
                return reply_1.default.err("上级ID错误");
            }
    ...
    async findUserInfoByUserIdAndPwd(userId, password) {
        ...
        if (!user) {
            return reply_1.default.err("没有此用户");
        }
        if (user.isFreeze == 1) {
            return reply_1.default.err('账号已被冻结');
        }
    ...
    //获取我的信息和角色信息
    async getMyInfoAndRoleInfo(userId) {
